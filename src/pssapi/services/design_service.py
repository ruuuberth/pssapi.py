...
class DesignService(_service_base.ServiceBase):
    async def list_all_designs(
        ...
        """List all game designs (blueprints for rooms, ships, items, crew, and more) in one versioned catalog call."""
    ...
    async def list_all_dynamic_designs(
        ...
        """List dynamic designs: item, promotion, and task blueprints that change frequently."""
        production_server = await self.get_production_server()
    ...
    async def list_all_static_designs(
        ...
        """List static designs: blueprints for rooms, ships, items, crew, star systems, sprites, and other fixed game content."""
        production_server = await self.get_production_server()
