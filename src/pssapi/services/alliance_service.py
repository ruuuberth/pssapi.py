...
from ..parsing import parse_entity as _parse_entity
from ..parsing import parse_entity_bundle as _parse_entity_bundle
...
class AllianceService(_service_base.ServiceBase):
    ...
    async def list_users(
        ...
        result = _parse_entity_bundle(
            response,
            (("Alliance", _Alliance, False), ("Users", _User, True)),
        )
